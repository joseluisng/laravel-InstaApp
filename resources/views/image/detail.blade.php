        ...
        <div class="col-md-10">
            ...
            <div class="card pub_image pub_image_detail">
                <div class="card-header">
                    ...
                    <div class="data-user">
                        {{ $image->user->name.' '.$image->user->suername }}
                        <span class="nickname">
                            {{ ' | @'.$image->user->nick }}
                        </span>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="comments">
                        ...
                        <form method="POST" action="{{ route('comment.save') }}">
                            ...
                            <p>
                                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" require></textarea>
                                @if($errors->has('content'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors_first('content') }}</strong>
                                    </span>
                                @endif
                            </p>
                        ...
                        @foreach($image->comments as $comment)
                            <div class="comment">
                                ...
                                <span class="nickname date">{{ ' | '.$comment->created_at }} </span>
